...
const Navbar = () => {
    ...
    const handleLogout = () => {
        if (keycloak) {
            ...
            const logoutUrl = `http://localhost:8080/realms/PatientSystem/protocol/openid-connect/logout?client_id=user-ms&post_logout_redirect_uri=${encodeURIComponent(redirectUri)}`;
